...
var HomePage = React.createClass({
	...
	getNutrientData: function getNutrientData(foodGroup) {
		...
		cs.get('/getfoods?id=' + foodGroup, function (status, foods) {
...
var short = [['1.1', 'grainBaked'], ['1.2', 'grainFreeBaked'], ['2.1.1', 'beer'], ['2.1.2', 'distilled'], ['2.1.3', 'liquor'], ['2.1.4', 'wine'], ['2.2.1', 'coffee'], ['2.2.2', 'tea'], ['2', 'cereal'], ['4.1', 'dairy'], ['4.2', 'egg'], ['5', 'fats'], ['6', 'fish'], ['7', 'fruits'], ['8', 'legumes'], ['9.1', 'beef'], ['9.2', 'pork'], ['9.3.1', 'chicken'], ['9.3.2', 'turkey'], ['9.3.3', 'duck'], ['9.3.4', 'goose'], ['9.4', 'lamb'], ['9.5.1', 'deer'], ['9.5.2', 'boar'], ['9.5.3', 'rabbit'], ['9.5.4', 'goat'], ['10', 'nuts'], ['11', 'spices'], ['12', 'vegetables']];
...
module.exports = {
	...
	food: {
		...
		post: function post(food, callback) {
			...
			if (validation.valid) {
				var queryString = '';
				queryString += '?category=' + food.category;
				queryString += '&description=' + food.description;
				queryString += '&enabled=' + food.enabled;
				queryString += '&id=' + food.id;
				queryString += '&keto=' + food.keto;
				queryString += '&name=' + food.name;
				queryString += '&paleo=' + food.paleo;

				cs.post('/postfood' + queryString, food, function (status) {
					if (status === bella.constants.response.OK) {
						callback(true, null);
					} else {
